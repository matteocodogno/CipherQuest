    ...
    dark: {
      palette: {
        ...
        background: {
          ...
          level1: 'linear-gradient(180deg, rgba(99, 91, 255, 0.50) 0%, rgba(117, 120, 255, 0.50) 100%)',
          level2: 'linear-gradient(180deg, rgba(99, 91, 255, 0.70) 0%, rgba(117, 120, 255, 0.70) 100%)',
